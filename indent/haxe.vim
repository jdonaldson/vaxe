...
" URL:			http://github.com/jdonaldson/vihxen
" Acknowledgement:      Based off of vim-js maintained by Darrick Wiebe (darrick at innatesofware.com) and vim-ruby maintained by Nikolai Weibull http://vim-ruby.rubyforge.org
" 0. Initialization {{{1
" =================
...
let s:syng_strcom = 'haxe\%(String\|Ereg\|Comment\|HaxeLineComment\|Comment\|DocComment\)'

" Regex of syntax group names that are strings.
let s:syng_string = 'haxe\%(Ereg\)'

" Regex of syntax group names that are strings or documentation.
let s:syng_multiline = 'haxeComment'
...
function GetHaxeIndent()
  ...
  " If it's a pound sign, it's a conditional compilation directive, remove
  "  the indent
  if line =~ '^\s*#' 
    return 0
  endif
